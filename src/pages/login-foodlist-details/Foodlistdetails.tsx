        ...
        <div className="restaurant-front spinner">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 ">
            <div className="flex flex-col sm:flex-row gap-[4rem]">
              ...
              <div className="sticky-side1 w-1/3">
                <h3 className="text-[#5f1909] text-[20px] font-bold">My Bag</h3>
                <span className="float-right block sm:hidden">&times;</span>

                <div className="cart_content1">
                  <div className="flex flex-col">
                    <div className="cart__items-wrapper">
                      <table className="table cart__restaurant-table">
                        <thead>
                          <tr>
